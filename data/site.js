...
export const milestones = [
  ...
  { year: "2015", title: "Airtel NLD rollout", body: "Executed turnkey OFC backbone packages for Bharti Airtel across Karnataka — HDD, trenching, blowing, splicing." },
  { year: "2018", title: "CGD entry", body: "Entered City Gas Distribution — MDPE and steel pipeline installation for gas network operators." },
  { year: "2021", title: "L&T EPC empanelment", body: "Empanelled as preferred underground OFC subcontractor for Larsen & Toubro telecom packages." },
  { year: "2023", title: "BSNL 4G saturation", body: "Delivered 24F OFC connectivity across Uttara Kannada for the BSNL 4G saturation programme." },
];
...
export const services = [
  ...
  },
  {
    ...
    summary: "Trenchless utility crossings under city roads, highways, railways and rivers — with our owned 5-machine HDD fleet.",
    bullets: [
      "Road, highway & railway crossings",
      "River crossings — long-bore capability",
      "HDPE, OFC duct & gas pipeline installation",
      "Owned 5-rig HDD fleet — maintained in-house",
    ],
  },
  {
...
export const projects = [
  {
    ...
    category: "Telecom",
    state: "Karnataka",
    value: "Turnkey package",
    duration: "2015 – 2016",
    status: "100% Completed",
    image: "https://images.unsplash.com/photo-1772600110243-f4e1349259b6",
  ...
  },
  {
    ...
    duration: "—",
    status: "Executed",
    image: "https://images.unsplash.com/photo-1559510981-10719ce4266a",
  ...
  },
  {
    ...
    client: "Confidential — industrial estates",
    category: "Electrical",
    state: "Karnataka",
    value: "Multiple packages",
    duration: "Recurring",
    status: "Ongoing",
    image: "https://images.unsplash.com/photo-1509390144018-eeaf65052242",
...
export const projectCategories = ["All", "Telecom", "HDD", "CGD", "Civil", "Electrical"];

export const machinery = [
  { name: "HDD Rigs", count: "5", spec: "Trenchless drilling — road, rail & river crossings", image: "https://images.unsplash.com/photo-1759579478942-a6992a87fb8f" },
